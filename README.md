...
## A Quick Overview 
 ...
 - 24-01-04. Released the Efficient Med-SAM-Adapter❗️ A new, faster, and more lightweight version incorporates Meta [EfficientSAM](https://yformer.github.io/efficient-sam/)🏇. Full credit goes to @shinning0821. Detailed information can be seen in [guidance/efficient_sam.ipynb](./guidance/efficient_sam.ipynb).
